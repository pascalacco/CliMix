...
function modifier_disabled_glob(val) {
...
function init_checker(checker, pere) {
    checker.pere = pere;
    checker.fils = [];
...
function selectionne(action) {
    ...
    let accordions = $('#accordionGroupes .accordion-item');
...
$(function () {
    ...
    get_info_puis(() => {
        ...
        neste_les_checks($('#accordionInsa')[0], null);
